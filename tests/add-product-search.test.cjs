...
for (const code of ['21-0001-10','51-0001-25']) { ctx.fseAddCode.value=code; assert.equal(ctx.isAddFormValid(),false,'Manual entry cannot bypass exclusion'); }
...
console.log('PASS: add-product suggestions omit 2/5 codes in stock and pallet catalogs; manual add blocks them');
